...
export async function createRunner(geometry = {}, fsId = 'fastffs') {
  ...
  const api = {
     ...
     *  3 live-data; drivers may emit higher classes (FAT+WL: 4 = WL/FTL
     *  bookkeeping, 5 = slack, allocated but carrying no data). Values pass
     *  through unclamped — the viz layer degrades unknown
