...
> Superseded for the *filesystem* model and granularity, but the NOR device semantics decided here carry forward
...
- A **configurable program granule** `G ∈ {1, 4, 16, 64, 256}` bytes.